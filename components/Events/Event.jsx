  ...
  return (
    <div className="bg-white/5 hover:bg-white/10 transition-all h-[440px] rounded-3xl flex flex-col justify-start p-4 w-[320px] sm:w-full mx-auto sm:mx-0">
      <div className="relative w-full h-[320px] mb-10">
        ...
        bg-[var(--color-accent)] w-[110px] h-[48px] text-[13px] uppercase font-medium rounded-full flex items-center justify-center"
        >
          {event.type}
        </div>
      </div>
      ...
      <div className="pl-4 flex flex-col justify-between h-[50%]">
        <div>
          <div className="flex items-center gap-3 text-[var(--color-accent)] mb-2">
            <div className="flex items-center gap-1">
              ...
              <BiCalendar /> 
              <div className="text-[15px]">15-08-26</div>
            </div>
            <div className="flex items-center gap-1">
              <BiTime /> 
        ...
        <div  className="flex items-center gap-2 pb-2">
          <BiMap className="text-xl  text-[var(--color-accent)]"/>
